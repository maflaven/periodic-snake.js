(function () {
  ...
  var Game = PSnake.Game = function (audio) {
    this.addSound = audio[0];
    this.removeSound = audio[1];
    this.shrinkSound = audio[2];
    this.snakes = [];
    this.paths = [];
    this.goodApples = [];
    this.badApples = [];
  ...
  Game.prototype.toggleGameOver = function () {
    this.gameOver = true;
  };
  ...
  Game.prototype.restart = function () {
    ...
    this.goodApples = [];
    this.badApples = [];
    this.snakes[0].pos = [Game.DIM_X * 0.2, Game.DIM_Y / 2];
    this.snakes[0].velparams = [1, 30];
    this.snakes[0].veltargets = [1, 30];
  };
})();
