(function () {
  ...
  Snake.prototype.move = function () {
    ...
    if (this.segments.length > 0) {
      this.segments[0].move(this.segmentOffsetPos(), 1);
    }
  };
  ...
  Snake.prototype.segmentOffsetPos = function () {
    var time = (this.game.time - this.radius * 2) % PSnake.Game.FPS;
